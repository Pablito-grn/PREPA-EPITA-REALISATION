...
namespace tp14
{
    public class NeuralNetwork
    {
        ...
        public NeuralNetwork(int[] layerDimension)
        {
            ...
            for (int i = 0; i < len; i++)
            {
                Layers[i] = new Layer(layerDimension[i], prevSize);
                prevSize = layerDimension[i];
            }
        }
        ...
        public NeuralNetwork(NeuralNetwork neuralNetwork, bool mutate)
        {
            ...
            {
                Layers[i] = neuralNetwork.Layers[i];
            }
        ...
        {
            for (var i = 0; i < Layers[0].Neurones.Length; i++)
            {
        ...
        {
            for (var i = 0; i < partner.Layers.Length; i++)
            {
